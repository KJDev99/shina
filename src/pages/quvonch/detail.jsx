...
export default function Detail() {
    ...
    return (
        <section className="overflow-hidden mt-[60px] lg:mt-[100px]">
            ...
            {/* Slider */}
            <div className="mt-[39px] pl-[calc((100vw-1400px)/2)] overflow-hidden">
                <Swiper
                    modules={[Autoplay]}
                    spaceBetween={20}
                    loop={true}
                ...
                >
                    {cards.map((item, index) => (
                        <SwiperSlide
                            key={index}
                            className="!w-[320px] lg:!w-[335px]"
                        >
                            <div className="h-[319px] bg-white p-6 rounded-[25px] flex flex-col justify-between cursor-pointer border border-gray-100">
                                ...
                                <div className="flex justify-between items-center mt-6">
                                    ...
                                    <div className="w-11 h-11 rounded-full bg-[#F5F5F5] flex justify-center items-center hover:bg-gray-200 duration-300 group">
                                        <img
