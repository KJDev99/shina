export default function Homenew() {
    const cards = [
        { num: "01", title: "Стабильность", img: "/quvonch/icon/sa.svg", text: "Выстраиваем надёжные и долгосрочные отношения с клиентами" },
        { num: "02", title: "Лучшие цены", img: "/quvonch/icon/sa2.svg", text: "Предлагаем выгодные условия и специальные предложения для покупателей" },
        { num: "03", title: "Широкий ассортимент", img: "/quvonch/icon/sa3.svg", text: "Большой выбор запчастей и материалов в наличии и под заказ" },
        { num: "04", title: "Качество", img: "/quvonch/icon/sa4.svg", text: "Поставляем только проверенные и надёжные комплектующие" },
        { num: "05", title: "Всегда онлайн", img: "/quvonch/icon/sa5.svg", text: "Оперативно отвечаем на запросы и помогаем в кратчайшие сроки" },
    ];
                    ...
                    <div className="relative grid grid-cols-3 gap-[10px]">
                        ...
                        <div className="flex flex-col justify-center gap-[10px]">
                            <div data-aos="fade-up"
                                ...
                                <img className="mt-3 h-[290px]" src="/quvonch/icon/sa2.svg" alt="Лучшие цены" loading="lazy" decoding="async" width="290" height="290" />
                            ...
                            <div data-aos="fade-up"
                                ...
                                <img className="mt-3 h-[290px]" src="/quvonch/icon/sa4.svg" alt="Качество" loading="lazy" decoding="async" width="290" height="290" />
                        ...
                        <div className="flex flex-col justify-center gap-[10px]">
                            <div data-aos="fade-up"
                                ...
                                <img className="mt-3 h-[290px]" src="/quvonch/icon/sa.svg" alt="Стабильность" loading="lazy" decoding="async" width="290" height="290" />
                            ...
                            <div data-aos="fade-up"
                                ...
                                <img className="mt-3 h-[290px]" src="/quvonch/icon/sa3.svg" alt="Широкий ассортимент" loading="lazy" decoding="async" width="290" height="290" />
                            ...
                            <div data-aos="fade-up"
                                ...
                                <img className="mt-[25px] h-[290px]" src="/quvonch/icon/sa5.svg" alt="Всегда онлайн" loading="lazy" decoding="async" width="290" height="290" />
