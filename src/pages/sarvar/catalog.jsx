      ...
      <div className="max-w-[1436px] m-auto mt-[30px] md:mt-[50px] mb-[100px] flex flex-col md:flex-row gap-8 px-4 md:px-0">
        <div className="w-full md:w-[344px] shrink-0 flex flex-col gap-4">
          <div className="bg-[#FFFFFF] p-5 rounded-[25px]">
            ...
            <div className="flex flex-col gap-[5px]">
              {[1, 2, 3, 4].map((item) => (
                <div
                  key={item}
                  className="bg-[#F5F5F5] h-[75px] rounded-[20px] flex items-center justify-between px-4"
                >
                  <h1 className="font-semibold text-[16px] leading-none tracking-normal uppercase">
                    Caterpillar
                  </h1>
                  <img
                    src="/sarvar/caterpillar-logo 1.svg"
                    alt="logo"
                    className="h-[25px]"
                  />
                </div>
          ...
          <div className="w-full bg-[#FFFFFF] p-[18px] rounded-[25px]">
            ...
            <div className="mt-6">
              <p className="font-medium text-[15px] leading-none tracking-normal mb-[10px]">
                Цена
              </p>
              <div className="flex items-center gap-2">
                <div className="flex-1 h-[72px] rounded-[15px] bg-[#F5F5F5] flex justify-center items-center">
                  0₽
                </div>
                <p className="text-[#111]">-</p>
                <div className="flex-1 h-[72px] rounded-[15px] bg-[#F5F5F5] flex justify-center items-center text-[13px] md:text-[15px]">
                  20 500 171₽
                </div>
              </div>
            </div>
        ...
        <div className="flex-1 flex flex-col gap-8">
          ...
          <div className="flex justify-center items-center gap-2 mt-4 flex-wrap">
            ...
            {[2, 3, 4].map((num) => (
              <button
                key={num}
                className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center bg-white text-[#111] rounded-[10px] font-semibold"
              >
                {num}
              </button>
            ))}
            <div className="w-8 flex justify-center items-end pb-3 text-[#888] font-bold">
              ...
            </div>
            {[12, 13].map((num) => (
              <button
