                ...
                <div className="flex">
                    ...
                    <div className="ml-[29px] relative mr-[24px]">
                        <input
                            ...
                            className="text-[#11111133] outline-none px-[34px] w-[574px] h-[90px] rounded-[69px] bg-[#FFFFFF]"
                            type="text"
                        />
                        <div className="absolute cursor-pointer top-[7px] right-[7px] w-[76px] h-[76px] rounded-full bg-[#F5F5F5] flex justify-center items-center font-normal text-[15px]">
                            <CiSearch size={22} />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center ml-[25px]">
                        <span className="flex flex-col items-end gap-[6px] mr-[25px]">
                            <p className="font-normal text-[14px] text-[gray]">Номер менеджера</p>
                            <h1 className="font-semibold text-[18px]">+7 (921) 905-70-21</h1>
                        </span>
                        <div className="h-[38px] bg-[gray] w-[2px]"></div>
                    ...
                    <div className="flex items-center relative">
                        <Link
                            to="/basket"
                            className="w-[59px] h-[59px] cursor-pointer bg-[white] ml-[25px] flex items-center justify-center rounded-full relative"
                        >
                            <img src="/quvonch/icon/shopicon.svg" alt="" />
                            {cartCount > 0 && (
                                <div className="absolute top-[-4px] right-[-4px] w-6 h-6 flex items-center justify-center border-4 border-[#f5ecec] rounded-[50%] text-sm font-semibold text-white bg-[#355094]">
                                    {cartCount}
                                </div>
                            )}
                        </Link>
                ...
                <div className="mt-[15px] w-[1400px] h-[88px] px-7 bg-white rounded-[69px] flex items-center gap-6">
                    {navItems.map((item, index) => (
                        <Link
                            ...
                            className={`font-normal text-[16px] uppercase whitespace-nowrap transition-all duration-300 ${active === index
